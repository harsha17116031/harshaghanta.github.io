                ...
                <article class="scroll-scale project-card group">
                  <div class="mb-4 flex items-start justify-between">
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        <h3 class="text-xl font-bold text-blue-100 group-hover:text-blue-300 transition">${project.name}</h3>
                  ...
                  <a class="inline-flex items-center gap-2 rounded-full border border-blue-400/40 px-4 py-2 text-sm font-semibold text-blue-100 transition hover:border-blue-300 hover:bg-blue-500/30 hover:shadow-lg hover:shadow-blue-500/20" href="${project.url}" target="_blank" rel="noopener noreferrer">
                    Visit Project
